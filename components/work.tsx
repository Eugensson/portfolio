  ...
  return (
    <Link href={href} className="group">
      <div className="w-full h-[300px] p-8 rounded-[30px] flex justify-center items-center mb-6 relative overflow-hidden bg-[#f4f4f4]">
        <Badge className="absolute z-40 top-6 left-6 capitalize bg-primary text-sm font-normal">
          {category}
        </Badge>
        <Image
          src={img}
      ...
      <div className="flex justify-center items-center">
        ...
        <button
          type="button"
          className="bg-accent text-white rounded-full w-12 h-12 flex items-center justify-center -rotate-45 group-hover:rotate-0 transition-all duration-500"
        >
